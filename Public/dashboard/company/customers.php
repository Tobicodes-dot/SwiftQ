...
<head>
    ...
    <title><?php echo htmlspecialchars($company_name); ?> - Customers</title>
        ...
        <div class="hidden lg:w-64 lg:flex lg:flex-col lg:bg-[#0A1A3A] lg:text-white lg:shadow-lg sticky top-0 h-screen">
            ...
            <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                <nav class="flex-1 px-2 space-y-1">
                    ...
                    <a href="./customers.php" class="bg-blue-600 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <div class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">View and manage all customers in the system</p>
                </div>
            ...
            <div class="flex-1 overflow-auto p-8">
                <div class="bg-white rounded-lg shadow p-8 text-center">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">Customers Page</h2>
                    <p class="text-gray-600">This page is under construction. Customer management features coming soon!</p>
                </div>
            </div>
        </div>
    </div>
